...
class PowersocketSettings extends StatefulWidget {
  final int itemIndex;
  ...
  @override
  _PowersocketSettingsState createState() => _PowersocketSettingsState();
}

class _PowersocketSettingsState extends State<PowersocketSettings> {
        ...
        child: Scaffold(
          ...
          body: Container(
            ...
            child: Container(
              child: ListView(
                children: [
                  OnOffState(widget.roomName, widget.sensorName, 8),
                  ContinueButton(),
                ],
              ),
            ),
