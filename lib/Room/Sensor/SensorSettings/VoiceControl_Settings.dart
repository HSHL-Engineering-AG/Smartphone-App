...
class VoiceControlSettings extends StatefulWidget {
  final int itemIndex;
  ...
  @override
  _VoiceControlSettingsState createState() => _VoiceControlSettingsState();
}

class _VoiceControlSettingsState extends State<VoiceControlSettings> {
        ...
        child: Scaffold(
          ...
          body: Container(
            ...
            child: Container(
              child: ListView(
                children: [
                  OnOffState(widget.roomName, widget.sensorName, 18),
                  ContinueButton(),
                ],
              ),
            ),
